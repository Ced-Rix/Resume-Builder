    ...
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-4 items-center">
          <a href="#login" className="text-gray-700 hover:text-indigo-600 transition text-sm">Log in</a>
          <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg transition text-sm font-medium">
            Sign up for free
          </button>
        </div>
      </div>
